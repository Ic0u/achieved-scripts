...
do
    function Library.CreateLoader(Title, WindowSize)
        ...
        --
        Library.Theme.Dummy = Utility.AddImage("https://i.imgur.com/6M6buVv.png")
        Library.Theme.Astolfo = Utility.AddImage("https://i.imgur.com/T20cWY9.png")
        Library.Theme.Aiko = Utility.AddImage("https://i.imgur.com/1gRIdko.png")
        Library.Theme.Rem = Utility.AddImage("https://i.imgur.com/ykbRkhJ.png")
        Library.Theme.Violet = Utility.AddImage("https://i.imgur.com/7B56w4a.png")
        Library.Theme.Asuka = Utility.AddImage("https://i.imgur.com/3hwztNM.png")
        --
